...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{book: $author$project$Main$Loading},
		$elm$http$Http$get(
			{
...
var $author$project$Main$keyDecoder = A2(
	$elm$json$Json$Decode$map,
	A2($elm$core$Basics$composeR, $author$project$Main$toKey, $author$project$Main$Keyboard),
	...
	function (_char, book) {
		...
		if (current.$ === 'Just') {
			...
			return (_Utils_eq(cr, _char) || (_Utils_eq(
				...
				cr,
				_Utils_chr('␣')))) ? $author$project$Book$move(book) : book;
		} else {
			return book;
		}
	});
				...
				if (_v2.$ === 'Success') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								book: $author$project$Main$Success(
									$author$project$Book$move(book))
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v3 = $elm$core$Debug$log('wtf');
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			default:
				var key = msg.a;
						...
						_Utils_update(
							model,
							{
								book: A2(
									...
									$author$project$Book$checkChar(_char),
									model.book)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Main$TestNext = {$: 'TestNext'};
...
var $author$project$Main$currentStyle = _List_fromArray(
	[
...
var $author$project$Main$futureStyle = _List_fromArray(
	[
...
var $author$project$Book$get = function (_v0) {
	...
	return _Utils_Tuple3(
		...
		A2(
			...
			bm.letter,
			$elm$core$Array$fromList(
				$elm$core$String$toList(currentWord))),
		_Utils_ap(
			A3(
				$elm$core$String$slice,
				bm.letter + 1,
				$elm$core$String$length(currentWord),
				currentWord),
			_Utils_ap(
				A2(
					$elm$core$String$join,
							...
							[
								...
								_List_fromArray(
									[
										...
										if (maybe_current_letter.$ === 'Nothing') {
											...
											return A2(
												$mdgriffith$elm_ui$Element$el,
												$author$project$Main$currentStyle,
								...
								A2(
									...
									_List_Nil,
									{
										...
										onPress: $elm$core$Maybe$Just($author$project$Main$TestNext)
									}))
							]));
			}
		}());
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"GotText":["Result.Result Http.Error String.String"],"TestNext":[],"Keyboard":["Main.Key"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Main.Key":{"args":[],"tags":{"Character":["Char.Char"],"Control":["String.String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Char.Char":{"args":[],"tags":{"Char":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));