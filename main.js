	...
	function (_char, book) {
		...
		if (current.$ === 'Just') {
			...
			return (_Utils_eq(cr, _char) || (_Utils_eq(
				...
				false) : _Utils_Tuple2(book, true);
		} else {
			return _Utils_Tuple2(book, false);
		}
	});
...
var $author$project$Main$currentStyle = function (mistyped) {
	return _List_fromArray(
		[
			...
			mistyped ? A3($mdgriffith$elm_ui$Element$rgb, 1, 0, 0) : A3($mdgriffith$elm_ui$Element$rgb, 0.1, 0.1, 0.1)),
